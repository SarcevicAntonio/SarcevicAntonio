...
<div class="flex flex-row xl:flex-col gap-4 sticky top-24 card card-body items-right h-card">
  ...
  <div class="flex-1 text-right my-auto">
    ...
    <a href="https://mastodon.online/@sarcevic" rel="me nofollow noopener noreferer" target="_blank" class="btn btn-ghost btn-xs bg-base-300 font-mono rounded-full mt-4">
      <span class="i-heroicons-solid-external-link !w-4 !h-4 mr-1" />
      Mastodon
    </a>
